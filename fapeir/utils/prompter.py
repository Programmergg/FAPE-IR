...
class Qwen2Prompter(Prompter):
    def __init__(self):
        ...
        self.default_system_prompt = (
            "You are an expert in low-level image processing. "
            "I will provide you with images exhibiting various degradations, such as noise, low brightness, snow, rain, fog, haze, or poor lighting conditions."
            "Your task is to autonomously identify the specific type of degradation in each image and propose suitable corrective methods."
        )
