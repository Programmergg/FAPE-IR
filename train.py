...
from fapeir.training.configuration_denoise import UnivaTrainingDenoiseConfig
...
def main(args: UnivaTrainingDenoiseConfig, attn_implementation='sdpa'):
    ...
    generic_dataset_types = _cfg_get(args.dataset_config, "generic_datasset_types", ["dehazing_test", "LOL2", "RealBlur_J", "RealBlur_R",
        ...
        for step, raw_batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(lvlm_model):
                ...
                if do_train_this_step:
                    ...
                    # L_freq values are appended per layer inside UnivaDenoiseTower.forward -> tower._freq_losses
